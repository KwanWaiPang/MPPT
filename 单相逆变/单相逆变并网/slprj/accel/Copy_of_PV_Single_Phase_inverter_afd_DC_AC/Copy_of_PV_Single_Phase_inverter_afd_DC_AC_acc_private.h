...
#ifndef RTW_HEADER_Copy_of_PV_Single_Phase_inverter_afd_DC_AC_acc_private_h_
#define RTW_HEADER_Copy_of_PV_Single_Phase_inverter_afd_DC_AC_acc_private_h_
#include "rtwtypes.h"
