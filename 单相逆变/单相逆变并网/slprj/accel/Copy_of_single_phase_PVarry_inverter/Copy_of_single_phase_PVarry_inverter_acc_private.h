...
#ifndef RTW_HEADER_Copy_of_single_phase_PVarry_inverter_acc_private_h_
#define RTW_HEADER_Copy_of_single_phase_PVarry_inverter_acc_private_h_
#include "rtwtypes.h"
...
; real_T Copy_of_single_phase_PVarry_inverter_acc_rt_TDelayInterpolate (
