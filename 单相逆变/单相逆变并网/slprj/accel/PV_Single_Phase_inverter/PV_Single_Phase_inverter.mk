...
MODEL              = PV_Single_Phase_inverter
MODULES            = PV_Single_Phase_inverter_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = PV_Single_Phase_inverter.mk
...
S_FUNCTIONS        = sfun_spssw_discc.c discreteVariableTransportDelay.c sfun_PV_array_MPPT.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 5
TID01EQ            = 0
...
MODELLIB                  = PV_Single_Phase_inverterlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/PV_Single_Phase_inverter \
	-I$(START_DIR) \
