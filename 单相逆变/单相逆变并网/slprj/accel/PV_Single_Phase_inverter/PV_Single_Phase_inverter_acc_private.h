...
#ifndef RTW_HEADER_PV_Single_Phase_inverter_acc_private_h_
#define RTW_HEADER_PV_Single_Phase_inverter_acc_private_h_
#include "rtwtypes.h"
...
; real_T PV_Single_Phase_inverter_acc_rt_TDelayInterpolate ( real_T
