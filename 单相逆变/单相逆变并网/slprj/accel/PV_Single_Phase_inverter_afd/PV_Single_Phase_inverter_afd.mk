...
MODEL              = PV_Single_Phase_inverter_afd
MODULES            = PV_Single_Phase_inverter_afd_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c 
MAKEFILE           = PV_Single_Phase_inverter_afd.mk
...
S_FUNCTIONS        = sfun_spssw_discc.c discreteVariableTransportDelay.c afd.c sfun_PV_array_MPPT.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 5
TID01EQ            = 0
...
MODELLIB                  = PV_Single_Phase_inverter_afdlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/PV_Single_Phase_inverter_afd \
	-I$(START_DIR) \
